...
<?= renderReconcileLiveProvePanel() ?>
    ...
    <div class="glass rounded-xl p-4 border border-sky-500/20">
        <p class="text-[11px] text-gray-500 mb-2">Runbook: filter by Registry partner; upload settlement CSV only when partner reconcile is wired ó otherwise keep rows for manual review.</p>
