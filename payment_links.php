    ...
    <div class="glass rounded-xl p-6">
        ...
        <form method="POST" class="space-y-4">
            ...
            <div>
                ...
                <p class="text-[11px] text-amber-400 mt-1">No methods unlocked yet. Open <a href="payment_methods.php" class="underline">Payment Methods</a> or use Payment Pack.</p>
                <?php elseif (count($availableMethods) === 1): ?>
                <p class="text-[11px] text-gray-500 mt-1">More methods: turn them ON under <a href="payment_methods.php" class="text-sky-400 hover:underline">Payment Methods</a>.</p>
                <?php endif; ?>
            </div>
            <div>
