...
renderPublicLegalPage([
    ...
    'sections' => [
        ['RBI and licensing disclosure', '<p><strong>' . e(COMPANY_LEGAL_NAME) . '</strong> provides merchant software for onboarding, checkout, reporting and settlement instructions. Live payment acquiring and settlement are performed by banks and payment gateways under their licences and agreements. UniWeb does <strong>not</strong> represent itself as an RBI-authorised Payment Aggregator, Payment Bank or NBFC unless a specific licence is granted and published on this site. Merchants should treat partner confirmation as authoritative for network transaction status.</p>'],
