...
<main class="company-page">
    ...
    <section class="company-section"><div class="company-shell">
        <div class="company-grid">
            ...
            <div class="company-card"><h3>Velocity &amp; fraud signals</h3><p>Failed payment and QR link rate limits reduce brute-force abuse. High-value and unusual patterns can be reviewed by ops.</p></div>
