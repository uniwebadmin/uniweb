...
<div class="max-w-md mx-auto px-4 pb-24 lg:pb-6 glass rounded-2xl p-8 border border-amber-500/20">
    ...
    <form method="post" class="space-y-4">
        ...
        <div><label class="text-sm text-gray-400">Password</label><input type="password" name="password" required class="input-field mt-1" autocomplete="current-password"></div>
        <div><label class="text-sm text-gray-400">Authenticator Code</label><input type="text" name="totp_code" required maxlength="6" pattern="[0-9]{6}" class="input-field mt-1 text-center text-xl tracking-widest"></div>
