...
<div class="flex flex-wrap gap-2 sm:gap-3 mb-4">
    ...
    <a href="admin_kyc.php" class="glass px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl text-xs sm:text-sm text-amber-400 hover:text-amber-300">KYC Ops</a>
