...
<div class="max-w-lg glass rounded-xl p-6">
    ...
    <form method="POST" class="space-y-4">
        ...
        <div><label class="text-sm text-gray-400">Name *</label><input type="text" name="name" required class="input-field mt-1"></div>
        ...
        <div><label class="text-sm text-gray-400">Agent Commission (%)</label><input type="number" name="agent_commission" value="0.50" step="0.01" min="0" max="5" class="input-field mt-1"></div>
        ...
        <button type="submit" class="btn-primary px-6 py-2.5">Create Agent</button>
    </form>
</div>
