...
<head>
    ...
    <link rel="stylesheet" href="<?= APP_URL ?>/assets/css/portal-polish.css?v=20260811b">
    ...
    <aside id="sidebar-panel" class="sidebar-shell w-64 bg-dark-900 border-r border-gray-800 fixed inset-y-0 left-0 z-50 lg:z-30 mobile-drawer lg:translate-x-0 lg:!transform-none flex flex-col">
        ...
        <nav class="sidebar-nav p-3 space-y-0.5 text-sm flex-1 overflow-y-auto">
            ...
            $merchantNav = [
                ...
                ['id' => 'collect', 'title' => 'Collect', 'items' => [
            ...
            $merchantHiddenUrls = [
                'merchant_nbfc.php','merchant_nbfc_loan.php','merchant_launch.php',
                'merchant_website.php','merchant_payment_pack.php','collection_settings.php',
                'payment_methods.php','orders.php','reports.php','disputes.php','chargebacks.php',
                'merchant_instant_settlement.php','merchant_payout.php','merchant_payout_keys.php',
                'merchant_settlement_settings.php','beneficiaries.php','invoices.php','agents.php',
                'merchant_customer_tickets.php','qr_analytics.php','merchant_shop_photos.php',
            ];
