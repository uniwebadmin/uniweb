    ...
    <aside id="admin-sidebar" class="sidebar-shell w-64 bg-dark-900 border-r border-gray-800 fixed inset-y-0 left-0 z-50 lg:z-30 mobile-drawer lg:translate-x-0 lg:!transform-none">
        ...
        <nav class="sidebar-nav p-3 space-y-0.5 text-sm">
            ...
            $adminNav = [
                ...
                ['admin_transactions.php','Transactions'],['admin_refunds.php','Refunds'],['admin_disputes.php','Disputes'],['admin_staff_activity.php','Staff Activity Log'],['admin_pg_webhooks.php','PG Webhooks'],['admin_reconciliation.php','PG Reconciliation'],
