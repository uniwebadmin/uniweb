...
<head>
    ...
    <link rel="stylesheet" href="<?= APP_URL ?>/assets/css/auth-portal.css?v=1">
    <?php endif; ?>
    <script>
    (function(){
        try {
    ...
    <aside id="sidebar-panel" class="sidebar-shell w-64 bg-dark-900 border-r border-gray-800 fixed inset-y-0 left-0 z-50 lg:z-30 mobile-drawer lg:translate-x-0 lg:!transform-none">
        ...
        <nav class="sidebar-nav p-3 space-y-0.5 text-sm">
            ...
            $nav = [
                ...
                ['payment_links.php',__('payment_links'),'M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-2.829 2.828a4 4 0 01-5.656 0l-4-4a4 4 0 115.656-5.656l1.102 1.101'],
    ...
    <aside id="admin-sidebar" class="sidebar-shell w-64 bg-dark-900 border-r border-gray-800 fixed inset-y-0 left-0 z-50 lg:z-30 mobile-drawer lg:translate-x-0 lg:!transform-none">
        ...
        <nav class="sidebar-nav p-3 space-y-0.5 text-sm">
            ...
            $adminNav = [
                ...
                ['admin_settlements.php','Settlements'],['admin_settlement_settings.php','Settlement Engine'],['admin_settlement_batches.php','Settlement Batches'],['admin_wallet.php','Platform Wallet'],['admin_payout.php','Payout Requests'],['admin_kyc.php','KYC Review'],['admin_method_requests.php','Method Requests'],
            ...
            ?>
            <a href="<?= $url ?>" class="block px-3 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-white/5 transition <?= $cur===$url?'bg-red-500/10 text-red-400':'' ?>"><?= $label ?></a>
            <?php endforeach; ?>
        </nav>
        <div class="sidebar-footer p-4">
