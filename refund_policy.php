...
renderPublicLegalPage([
    ...
    'sections' => [
        ...
        ['Merchant-initiated refund timing', '<p>When a merchant approves a refund in the UniWeb portal, status shows as pending or completed there. Credit to your bank/UPI/card usually takes <strong>3–7 business days</strong> depending on the issuer — the portal status is not the same as money in your account.</p>'],
        ['Disputes / chargebacks', '<p>You can raise a dispute with your bank or card network. The merchant must respond with proof (order, delivery, etc.) by the deadline given. This is <strong>not</strong> the same as a voluntary merchant refund.</p>'],
