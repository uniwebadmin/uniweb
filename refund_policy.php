...
renderPublicLegalPage([
    ...
    'sections' => [
        ...
        ['Escalation', '<p>If the merchant has confirmed a refund but the expected bank timeline has passed, obtain the refund reference and contact the issuing bank. You may also contact UniWeb support for available technical status, or follow the structured process on our <a href="grievance.php">Grievance Redressal</a> page. Legal and consumer remedies remain available under applicable law.</p>'],
    ],
]);
