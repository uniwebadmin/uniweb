...
renderPublicLegalPage([
    ...
    'sections' => [
        ...
        ['How to ask for a refund', '<p>Share your transaction ID, amount, date and a short description via the <a href="contact.php">Contact page</a>. Never send card numbers, CVV, PIN or OTP.</p>'],
