...
renderPublicLegalPage([
    ...
    'sections' => [
        ['Overview', '<p>UniWeb operates as a Payment Aggregator. We route transactions to certified payment partners, manage merchant onboarding/KYC, handle reconciliation, and provide dispute resolution. Each party has specific responsibilities to ensure smooth, compliant payment processing.</p>'],
