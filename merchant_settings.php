...
$globalCards = [
    ['my_account.php', 'Profile Details', 'Name, business, PAN, GST, address', 'View details', 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14'],
    ...
    ['merchant_2fa.php', '⭐ Two-Factor Authentication', 'Optional authenticator app login security', 'Manage 2FA', 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 10-8 0v4h8z'],
