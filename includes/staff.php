...
function staffNavForRole(string $role): array
{
    ...
    $all = [
        ...
        'admin_disputes.php' => ['Cases · Disputes', ['super', 'ceo', 'regional_manager', 'team_leader', 'support', 'ops']],
        'admin_support.php' => ['Cases', ['super', 'ceo', 'regional_manager', 'team_leader', 'support', 'ops']],
        'admin_customer_tickets.php' => ['Cases · Complaints', ['super', 'ceo', 'regional_manager', 'team_leader', 'support', 'ops']],
        ...
        'admin_risk_engine.php' => ['Risk Engine', ['super', 'ceo', 'ops', 'finance']],
