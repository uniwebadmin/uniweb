...
function uniwebMerchantNavGroups(): array
{
    ...
    return [
        ...
        ['id' => 'collect', 'title' => 'Collect / P2M', 'items' => [
            ...
            ['merchant_recurring.php', 'Recurring / AutoPay', 'M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15'],
        ]],
        ...
        ['id' => 'settlements', 'title' => 'Settlements', 'items' => [
            ...
            ['settlements.php', $t('settlements', 'Settlements'), 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01'],
        ...
        ['id' => 'tools', 'title' => 'Tools / Settings', 'items' => [
            ...
            ['api_settings.php', $t('api_settings', 'UniWeb API Keys'), 'M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z'],
...
function uniwebAdminNavGroups(): array
{
    ...
    return [
        ...
        ['id' => 'advanced_risk', 'title' => 'Advanced · Risk', 'collapsed' => true, 'items' => [
            ['admin_aml.php', 'AML Flags'],
            ['admin_risk.php', 'Risk Rules'],
            ['admin_risk_engine.php', 'Risk Engine'],
            ['admin_chargebacks.php', 'Chargebacks (legacy ingest)'],
...
function uniwebMerchantSearchPages(): array
{
    ...
    $extras = [
        ...
        // Agents kept findable via search; hidden from sidebar until franchise CRUD is primary (PNL-SM01).
        ['agents.php', 'Agents (franchise children)'],
    ];
