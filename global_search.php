...
$featureAliases = [
    ...
    'payu keys' => 'admin_gateway_registry.php',
    'razorpay keys' => 'admin_gateway_registry.php',
    'cashfree keys' => 'admin_gateway_registry.php',
    'merchant api keys' => $isMerchant ? 'api_settings.php' : 'admin_website.php',
    'uniweb api keys' => $isMerchant ? 'api_settings.php' : 'admin_website.php',
    'today' => 'admin_kyc.php',
    ...
    'api keys' => $isMerchant ? 'api_settings.php' : 'admin_gateway_registry.php',
    ...
    'aml' => 'admin_aml.php',
    'risk' => 'admin_risk.php',
    'chargeback' => $isMerchant ? 'disputes.php' : 'admin_disputes.php',
    'chargebacks' => $isMerchant ? 'disputes.php' : 'admin_disputes.php',
