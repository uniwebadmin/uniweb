...
<div class="max-w-6xl mx-auto space-y-4 sm:space-y-6 min-w-0">
    <div>
        ...
        <p class="text-sm text-gray-400 mt-1">Manual forward + status matrix for <code class="text-xs bg-gray-800 px-1 rounded">gateway_submissions</code>. After Admin Verify, the automatic <a href="admin_kyc.php?tab=forward" class="text-sky-400 hover:underline">KYC Forward Queue</a> also enqueues one row per partner with keys — mostly <strong class="text-amber-300">staged</strong> until live API. Use this page to bulk-forward or update submission status; cron does not replace your review here.</p>
