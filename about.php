...
<main class="company-page">
    ...
    <section class="company-section" style="padding-top:0"><div class="company-shell"><div class="company-cta">
        ...
        <div class="flex flex-wrap gap-3"><a href="platform_demo.php" class="btn-primary px-6 py-3">View platform tour</a><a href="merchant_register.php" class="px-6 py-3 rounded-lg border border-gray-700">Create merchant account</a></div>
    </div></div></section>
</main>
