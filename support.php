...
$supportWhatsapp = preg_replace('/[^0-9]/', '', (string)getSetting('support_whatsapp', defined('SUPPORT_WHATSAPP') ? SUPPORT_WHATSAPP : '919900000000'));
$supportChannels = [
    ['key' => 'whatsapp', 'label' => 'WhatsApp', 'color' => 'emerald', 'url' => 'https://wa.me/' . $supportWhatsapp, 'icon' => '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>'],
    ['key' => 'email', 'label' => 'Email', 'color' => 'sky', 'url' => 'mailto:' . getSetting('support_email', defined('SUPPORT_EMAIL') ? SUPPORT_EMAIL : COMPANY_SUPPORT_EMAIL), 'icon' => '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>'],
    ['key' => 'phone', 'label' => 'Call', 'color' => 'amber', 'url' => 'tel:' . getSetting('support_phone', defined('COMPANY_PHONE') ? COMPANY_PHONE : '+911140000000'), 'icon' => '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>'],
    ['key' => 'instagram', 'label' => 'Instagram', 'color' => 'pink', 'url' => getSetting('support_instagram', defined('SUPPORT_INSTAGRAM') ? SUPPORT_INSTAGRAM : 'https://instagram.com/uniweb'), 'icon' => '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"/></svg>'],
    ['key' => 'telegram', 'label' => 'Telegram', 'color' => 'cyan', 'url' => getSetting('support_telegram', defined('SUPPORT_TELEGRAM') ? SUPPORT_TELEGRAM : 'https://t.me/uniweb'), 'icon' => '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>'],
    ['key' => 'facebook', 'label' => 'Facebook', 'color' => 'blue', 'url' => getSetting('support_facebook', defined('SUPPORT_FACEBOOK') ? SUPPORT_FACEBOOK : 'https://facebook.com/uniweb'), 'icon' => '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"/></svg>'],
    ['key' => 'twitter', 'label' => 'Twitter / X', 'color' => 'gray', 'url' => getSetting('support_twitter', defined('SUPPORT_TWITTER') ? SUPPORT_TWITTER : 'https://x.com/uniweb'), 'icon' => '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z"/></svg>'],
    ['key' => 'linkedin', 'label' => 'LinkedIn', 'color' => 'indigo', 'url' => getSetting('support_linkedin', defined('SUPPORT_LINKEDIN') ? SUPPORT_LINKEDIN : 'https://linkedin.com/company/uniweb'), 'icon' => '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-2-2 2 2 0 00-2 2v7h-4v-7a6 6 0 016-6zM2 9h4v12H2zM4 6a2 2 0 11-4 0 2 2 0 014 0z"/></svg>'],
    ['key' => 'youtube', 'label' => 'YouTube', 'color' => 'red', 'url' => getSetting('support_youtube', defined('SUPPORT_YOUTUBE') ? SUPPORT_YOUTUBE : 'https://youtube.com/@uniweb'), 'icon' => '<svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg>'],
];
...
<div class="glass rounded-xl p-6 mb-6">
    ...
    <p class="text-xs text-gray-500 mb-4">Reach us on any channel you prefer. Admin updates these links from Gateway Settings → Support Channels.</p>
