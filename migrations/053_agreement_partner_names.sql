...
ALTER TABLE merchant_agreement_acceptances ADD COLUMN IF NOT EXISTS partner_names VARCHAR(500) DEFAULT NULL;
ALTER TABLE merchant_agreement_acceptances ADD COLUMN IF NOT EXISTS requires_resign TINYINT(1) NOT NULL DEFAULT 0;
