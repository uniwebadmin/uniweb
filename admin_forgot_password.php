    ...
    <div class="w-full max-w-md">
        ...
        <div class="glass rounded-2xl p-8 border border-red-500/10">
            ...
            <div class="text-center">
                ...
                <p class="text-xs text-gray-600 mb-5">The link is single-use and expires in 30 minutes.</p>
            ...
            <form method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <input type="text" name="identifier" required autocomplete="username" class="input-field mt-1">
                </div>
