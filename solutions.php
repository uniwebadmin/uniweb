...
$products = [
    [
        ...
        'body' => 'Customers pay on a secure UniWeb checkout — UPI, Card, Net Banking and Wallets as method tabs only (no partner brand buttons). Test Mode works immediately. Live methods appear after Admin activates networks in Partner Registry.',
    ...
    [
        ...
        'eyebrow' => 'Collections',
        'title' => 'Payment links',
        'body' => 'Create shareable links for invoices, deposits or one-time orders. Track views, status and settlements from one merchant dashboard — no separate signup at each payment company.',
    ...
    [
        ...
        'body' => 'Fixed-amount, dynamic UPI and all-method QR journeys for shops, counters and field teams.',
