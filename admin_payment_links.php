...
<div class="container mx-auto px-4 py-6">
    ...
    <form method="GET" class="glass rounded-xl p-4 mb-6 border border-gray-800 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 items-end">
        ...
        <div><label class="text-[10px] text-gray-600 uppercase block mb-1">Merchant</label><?= renderAdminMerchantSelect('merchant_id', $merchantFilter, false, false, '', true, true) ?></div>
