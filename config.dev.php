...
if (session_status() === PHP_SESSION_NONE) {
    if (PHP_SAPI !== 'cli') {
        ...
        sendUniwebSecurityHeaders(uniwebIsSensitivePortalPage());
    }
}
...
$__includes = [
    ...
    'wallet', 'settlement_engine', 'reconciliation', 'refunds', 'chargebacks', 'partner_registry_v2', 'partner_doc_coverage',
    ...
    'integration_matrix', 'integration_matrix_workflow', 'settlement_delay_spec', 'kyc_timeline', 'cloud_modules',
    'beneficiaries',
    'audit_log',
    'payout_jobs',
    'payout_adapters',
